...
> [`packages/hexcore/tests/test_darwin_custom_plugin.py`](../../../../packages/hexcore/tests/test_darwin_custom_plugin.py). Si esta
...
- [`packages/hexcore/tests/test_darwin_custom_plugin.py`](../../../../packages/hexcore/tests/test_darwin_custom_plugin.py) — todo esto,
  ejecutado
