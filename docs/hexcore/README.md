...
> ← Back to the [monorepo documentation index](../), which also covers the
> [TypeScript client](../darwin-client/).
...
| :-- | :-- | :-- |
| [ARCHITECTURE_TYPING.md](../ARCHITECTURE_TYPING.md) | EN | The type system, the generated stubs and the CI gate. The contract for contributing. |
| [Darwin Client](../darwin-client/) | EN · ES | The TypeScript client for Darwin, this package's identity module. |
| [CHANGELOG.md](../../CHANGELOG.md) | ES | Change history. Generated by `commitizen` from the commit subjects, which are written in Spanish. |
| [CONTRIBUTING.md](../../CONTRIBUTING.md) | EN | How to contribute. |
| [SECURITY.md](../../SECURITY.md) | EN | Security policy. |
...
`packages/hexcore/tests/test_documentation_examples.py` executes the startup examples, verifies that every
